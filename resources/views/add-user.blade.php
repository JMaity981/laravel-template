...
<html lang="en">
                        ...
                        <form>
                           <div class="form-group">
                              <div class="add-img-user profile-img-edit">
                                 <img class="profile-pic img-fluid" src="public/assets/images/user/11.png" alt="profile-pic">
                                 <div class="p-image">
   ...
   <!-- Wrapper END -->
    ...
    <!-- Optional JavaScript -->
      ...
      <!-- lottie JavaScript -->
      <script src="public/assets/js/lottie.js"></script>
